...
pub(crate) struct ClientHelloInput {
    ...
    pub(super) craft_connection_data: crate::craft::CraftConnectionData,
...
impl ClientHelloInput {
    pub(super) fn new(
        ...
        let craft_connection_data =
            crate::craft::CraftConnectionData::new(config.provider().secure_random)?;
        Ok(Self {
            config,
            resuming,
            random,
