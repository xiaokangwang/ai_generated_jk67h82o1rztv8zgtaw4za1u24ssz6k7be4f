...
pub struct ClientConfig {
    ...
    /// Craftls ClientHello fingerprint customization.
...
impl ClientConfig {
    ...
    /// Apply a craftls ClientHello fingerprint to this client configuration.
    pub fn with_fingerprint(self, fingerprint_builder: crate::craft::FingerprintBuilder) -> Self {
    ...
    pub(crate) fn set_provider_for_craft(&mut self, provider: Arc<CryptoProvider>) {
        self.domain.provider = provider;
    }
